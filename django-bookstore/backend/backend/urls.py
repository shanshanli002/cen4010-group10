...
urlpatterns = [
    ...
    path(r'allcustomer/',CustomerView.as_view(),name ="allcustomer"),
    path(r'allcustomer/username=ChampangePapi/',RetrieveUser.as_view()),
    path(r'allcustomer/listcards/',ListCards.as_view(), name="allcustomer-listcards"),
